...
class BorgInterface:
    ...
    def __init__(self):
        # Allow overriding borg command via environment for development/testing
        # e.g. set BORG_CMD to full path of a fake borg script on Windows
        self.borg_cmd = os.getenv("BORG_CMD", "borg")
