    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <History size={32} />
          <Box>
            <Typography variant="h4">活动</Typography>
        ...
        <Box sx={{ display: 'flex', gap: 2 }}>
          <FormControl size="small" sx={{ minWidth: 150 }}>
            ...
            >
              ...
              <MenuItem value="restore">还原</MenuItem>
              <MenuItem value="check">检查</MenuItem>
              <MenuItem value="compact">压缩</MenuItem>
              <MenuItem value="prune">修剪</MenuItem>
              <MenuItem value="package">打包</MenuItem>
            </Select>
          </FormControl>
